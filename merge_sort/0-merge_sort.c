...
/**
 * merge_sort_holder - sorts an array of integers in ascending order
 * using the top-down merge sort algorithm
 * and includes a temporary array to hold information during the merge
 * @array: array of integers to sort
 * @size: size of the array of integers to sort
 * @holder: temporary array to hold information during the merge
 */
 ...
 * @mid: index of the midpoint
 * @size: size of the array to merge
 */
